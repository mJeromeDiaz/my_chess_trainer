<template>
  <div class="row">
    <board :puzzleLichess="puzzle" @updatePuzzle="updatePuzzle" v-if="puzzle.length > 0"></board>
    <div class="">
      <q-btn
        flat
        color="primary"
...
<script setup>
import board from 'components/Puzzle.vue'
...
function updatePuzzle(){
  ...
  puzzle.value = ''
  puzzle.value = puzzlesLichess[iteration.value];
}
